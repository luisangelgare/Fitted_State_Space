...
if opts.spy2==1
  ...
  if opts.logx==1     
    if opts.logy==1
      figure(1),
      h1=loglog(freq,abs(f),'b','linewidth',1.2); xlim([freq(1) freq(Ns)]);hold on
      h2=loglog(freq,abs(fit),'r--','linewidth',1.2); hold off
      if opts.errplot== 1
        hold on,h3=loglog(freq,abs(f-fit),'g','linewidth',1.2);hold off; 
      end
    else %logy=0 
      figure(1),
      h1=semilogx(freq,abs(f),'b','linewidth',1.2); xlim([freq(1) freq(Ns)]);hold on
      h2=semilogx(freq,abs(fit),'r--','linewidth',1.2); hold off
      if opts.errplot== 1
        hold on,h3=semilogx(freq,abs(f-fit),'g','linewidth',1.2);hold off; 
      end
    end
    if opts.phaseplot==1
      figure(2),
      h4=semilogx(freq,180*unwrap(angle(f))/pi,'b','linewidth',1.2); xlim([freq(1) freq(Ns)]);hold on
      h5=semilogx(freq,180*unwrap(angle(fit))/pi,'r--','linewidth',1.2);hold off
    end  
  else %logx=0
    if opts.logy==1
      figure(1),
      h1=semilogy(freq,abs(f),'b','linewidth',1.2); xlim([freq(1) freq(Ns)]);hold on
      h2=semilogy(freq,abs(fit),'r--','linewidth',1.2); hold off
      if opts.errplot== 1
        hold on,h3=semilogy(freq,abs(f-fit),'g','linewidth',1.2);hold off; 
      end
    else %logy=0 
      figure(1), 
      h1=plot(freq,abs(f),'b','linewidth',1.2); xlim([freq(1) freq(Ns)]);hold on
      h2=plot(freq,abs(fit),'r--','linewidth',1.2); hold off
      if opts.errplot== 1
        hold on,h3=plot(freq,abs(f-fit),'g','linewidth',1.2);hold off; 
      end
    end
    if opts.phaseplot==1    
      figure(2),
      h4=plot(freq,180*unwrap(angle(f))/pi,'b','linewidth',1.2); xlim([freq(1) freq(Ns)]);hold on
      h5=plot(freq,180*unwrap(angle(fit))/pi,'r--','linewidth',1.2);hold off
    end  
  end %logy=0
  figure(1),
